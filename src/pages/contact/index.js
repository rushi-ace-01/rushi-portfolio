  ...
  render() {
    return (
      <div>
        <Helmet>
          <meta charSet="utf-8" />
          <title>Contact | Rushikesh Gavhane</title>

          {/* Canonical URL – update domain later if needed */}
          <link
            rel="canonical"
            href="https://rushi-portfolio.vercel.app/contact"
          />

          <meta
            name="description"
            content="Contact Rushikesh Gavhane — MSc Data Analytics & AI student at Queen Mary University of London. Open to roles in machine learning, data science, and AI engineering."
          />
        </Helmet>
